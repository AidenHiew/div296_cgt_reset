...
def recalc_solution(tmp_path_factory) -> dict:
    ...
    return {
        # Inputs
        "member1_proportion": at("Inputs", "D66"),
        ...
        "totals_ord_cgt": at("Analyser", "F70"),
        "totals_div296_adj_gain": at("Analyser", "G70"),
        "totals_div296_tax": at("Analyser", "H70"),
        # Comparison subtotals + net effect
        "scenario_a_tax": at("Comparison", "C69"),
        "scenario_b_tax": at("Comparison", "G69"),
        "net_effect": at("Comparison", "C72"),
    }
